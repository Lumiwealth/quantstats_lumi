...
API documentation is automatically generated for each version of the library using [pdoc](https://pdoc.dev/). This documentation provides a comprehensive reference of all modules, classes, functions, and methods in the package.

The documentation is generated by a GitHub Actions workflow whenever changes are pushed to the repository. The generated documentation is available as an artifact in the GitHub Actions workflow run.

To access the latest API documentation:
1. Go to the [Actions tab](https://github.com/Lumiwealth/quantstats_lumi/actions) in the GitHub repository
2. Click on the most recent "DOCUMENTATION" workflow run
3. Scroll down to the "Artifacts" section
4. Download the "pdoc" artifact
5. Extract the downloaded zip file and open the index.html file in your browser

In the meantime, you can also get insights about optional parameters for each method by using Python's `help` method:
